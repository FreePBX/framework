...
$template['content'] = 
	...
	"<p>"._("The suspect URL is listed below. If this action is intended, you can click this link and your action will be processed. Do not proceed with this if you did not intended to execute this command as it may result in changes to your configuraiton.")."</p>\n".
