...
class freepbx_conf {
  ...
  function amportal_generate($verbose=true) {
    ...
    $conf_string .= _("#; custom modifications, details at: http://freepbx.org/configuration_files       ;\n");
    $conf_string .= _("#;--------------------------------------------------------------------------------;\n\n\n");
    $conf_string .= _("#;--------------------------------------------------------------------------------;\n");
    ...
    // Note, I am not going to localized the name field, this is a conf file, I suspect english is ok? The warning is
    // localized which should be adequate to say DON'T MESS WITH THIS!
    //
    $category = '';
