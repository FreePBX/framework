...
class Reload extends Command {
	...
	private function reload() {
		...
		// Delete the webserver authentication notification if not webserver or none
		if ($this->freepbx->Config->get('AUTHTYPE') != 'webserver' && $this->freepbx->Config->get('AUTHTYPE') != 'none') {
