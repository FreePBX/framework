...
class AGI_AsteriskManager {
	...
	* @param string $actionid message matching variable
	*/
	function GetVar($channel=null, $variable=null, $actionid=NULL) {
	...
	*/
	...
	function database_get($family, $key) {
		if ($this->useCaching) {
			...
			$r = $this->command("database get ".freepbx_str_replace(" ","/",$family)." ".freepbx_str_replace(" ","/",$key));
