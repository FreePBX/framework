...
$('.menubar').menubar().hide().show();$('.module_menu_button').hover(function(){$(this).click();var sh=$(window).height();$('.ui-menu').each(function(){if($(this).css('display')=='block'){$(this).css('max-height','');if($(this).height()>sh){$(this).css('max-height',sh-50+'px');}}});});if(fpbx.conf.reload_needed){toggle_reload_button('show');}
