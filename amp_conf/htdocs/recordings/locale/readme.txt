...
$ find ../includes/*.php ../modules/*.module ../misc/*.php ../theme/*.php | xargs xgettext -L PHP -o ari.po --keyword=_ -
...
msgmerge zh_TW/LC_MESSAGES/ari.po ari.utf-8.po --output-file=zh_TW/LC_MESSAGES/ari.po
