...
$email = $cm->get_email();
if ($email) {
	$brand = $ampconf[DASHBOARD_FREEPBX_BRAND]?$ampconf[DASHBOARD_FREEPBX_BRAND]:'FreePBX';
	$mid = $cm->get_machineid();
	$text  = "This notification was generated by the $brand Server identified as '$mid'.\n";
	$text .= "You may change this designation in the module admin page, by clicking on the alert icon ";
	$text .= "in the top right hand corner of the page.\n";
