...
if ($email) {
	...
	$htext  = _( sprintf("This notification was generated by the %s Server identified as '%s'.\n"),$brand,$mid);
	$htext .= _("You may change this designation in the module admin page, by clicking on the alert icon ");
	$htext .= _("in the top right hand corner of the page.\n");
