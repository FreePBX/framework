...
logfiles_url=${module_url}/logfiles
...
svn cp -m "Automatic packaging of logfiles with $ver"         $logfiles_url         http://www.freepbx.org/v2/svn/freepbx/tags/${ver}/amp_conf/htdocs/admin/modules/
