...
class Installer {
	...
	'description' => "The asterisk application to use for conferencing. As the app_meetme Asterisk application is deprecated and scheduled for removal in Asterisk 21, it's recommended that it be changed to app_confbridge.",
	'type' => CONF_TYPE_SELECT,
	);
