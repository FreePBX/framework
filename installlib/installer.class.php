...
class Installer {
	...
	'description' => 'When set to true, the system will check for a freepbx_menu.conf file amongst the normal configuraiton files and if found, it will be used to define and remap the menu tabs and contents. See the template supplied with FreePBX for details on how to do this.',
	'type' => CONF_TYPE_BOOL,
	);
	...
	'description' => 'Default setting for SIP canreinvite (same as directmedia). See Asterisk documentation for details.',
	'type' => CONF_TYPE_SELECT,
	'sortorder' => 20,
	);
	...
	'name' => 'SIP trustrpid',
	'description' => 'Default setting for SIP trustrpid. See Asterisk documentation for details.',
	'type' => CONF_TYPE_SELECT,
	'sortorder' => 30,
	);
	...
	'options' => array('no', 'yes'),
	'name' => 'SIP encryption',
	'description' => "Default setting for SIP encryption. Whether to offer SRTP encrypted media (and only SRTP encrypted media) on outgoing calls to a peer. Calls will fail with HANGUPCAUSE=58 if the peer does not support SRTP. See Asterisk documentation for details.",
	'type' => CONF_TYPE_SELECT,
	'sortorder' => 60,
	);
	...
	'description' => "Default setting for SIP qualifyfreq. Only valid for Asterisk 1.6 and above. Frequency that 'qualify' OPTIONS messages will be sent to the device. Can help to keep NAT holes open but not dependable for remote client firewalls. See Asterisk documentation for details.",
	'type' => CONF_TYPE_INT,
	'sortorder' => 70,
	);
	...
	'description' => "Default setting for SIP and IAX allow (for codecs). Codecs to allow in addition to those set in general settings unless explicitly 'disallowed' for the device. Values van be separated with '&' e.g. 'ulaw&g729&g729' where the preference order is preserved. See Asterisk documentation for details.",
	'type' => CONF_TYPE_TEXT,
	'emptyok' => 1,
	'sortorder' => 90,
	);
	...
	'description' => "Default setting for SIP, DAHDi (and Zap) callgroup. Callgroup(s) that the device is part of, can be one or more callgroups, e.g. '1,3-5' would be in groups 1,3,4,5. See Asterisk documentation for details.",
	'type' => CONF_TYPE_TEXT,
	'emptyok' => 1,
	'sortorder' => 100,
	);
	...
	'description' => "Default setting for SIP, DAHDi (and Zap) pickupgroup. Pickupgroups(s) that the device can pickup calls from, can be one or more groups, e.g. '1,3-5' would be in groups 1,3,4,5. Device does not have to be in a group to be able to pickup calls from that group. See Asterisk documentation for details.",
	'type' => CONF_TYPE_TEXT,
	'emptyok' => 1,
	'sortorder' => 110,
	);
